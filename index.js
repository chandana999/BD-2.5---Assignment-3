...
function sortHotelsByPricingASC(hotels1, hotels2){
 return hotels1.price - hotels2.price;
}

function sortHotelsByPricingDESC(hotels1, hotels2){
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if(pricing === 'low-to-high'){
    hotelsCopy.sort(sortHotelsByPricingASC);
  } else {
    hotelsCopy.sort(sortHotelsByPricingDESC);
  }
  res.json(hotelsCopy);
});


function sortHotelsByRatingASC(hotels1, hotels2){
  return hotels1.rating - hotels2.rating;
 }
 
function sortHotelsByRatingDESC(hotels1, hotels2){
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if(rating === 'low-to-high'){
    hotelsCopy.sort(sortHotelsByRatingASC);
  } else {
    hotelsCopy.sort(sortHotelsByRatingDESC);
  }
  res.json(hotelsCopy);
});


function sortHotelsByReviewsASC(hotels1, hotels2){
  return hotels1.reviews - hotels2.reviews;
 }
 
function sortHotelsByReviewsDESC(hotels1, hotels2){
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if(reviews === 'least-to-most'){
    hotelsCopy.sort(sortHotelsByReviewsASC);
  } else {
    hotelsCopy.sort(sortHotelsByReviewsDESC);
  }
  res.json(hotelsCopy);
});
